            ...
            {steps.map((step, index) => (
              ...
              >
                <div className="flex-shrink-0">
                  <div className="w-16 h-16 bg-green-600 rounded-full flex items-center justify-center text-white font-bold text-lg group-hover:bg-green-700 group-hover:scale-110 transition-all duration-300">
                    {step.number}
                  </div>
                </div>
